...
import { cancelJob, clearJobs, jobLog, retryJob } from "../data/daemon";
import { colors, text, timing } from "../design/tokens.stylex";
...
const styles = stylex.create({
  ...
  kept: { alignSelf: "center", color: colors.muted, fontSize: text.small },

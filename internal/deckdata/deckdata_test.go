...
func TestAllScopePinDragsWholeStack(t *testing.T) {
	...
	items := []Item{
		{WorkspaceName: "other", ProjectName: "alpha", RepoRoot: "/r", PRNumber: 99, Bookmark: "other"},
		{WorkspaceName: "base", ProjectName: "alpha", RepoRoot: "/r", PRNumber: 2264, Bookmark: "base"},
		{WorkspaceName: "tip", ProjectName: "alpha", RepoRoot: "/r", PRNumber: 2137, Bookmark: "tip", PinGroup: "default"},
	}

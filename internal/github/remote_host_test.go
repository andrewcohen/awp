...
func TestOriginHostReadsBothShapesGitWrites(t *testing.T) {
	cases := []struct {
		...
		{"git@gitlab.com:harborworks/harbor-works.git", "gitlab.com"},
		{"git@bitbucket.org:lanterninc/lantern-shop.git", "bitbucket.org"},
		{"ssh://git@github.com/andrewcohen/typed-router-poc.git", "github.com"},
